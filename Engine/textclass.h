...
public:
	...
	bool SetFinishedText(ID3D11DeviceContext*);
...
private:
	...
	FontClass* m_Font;
	SentenceType *m_sentence1, *m_sentence2, *m_sentence3, *m_sentence4, *m_sentence5, *m_sentence6;
	SentenceType *m_sentence7, *m_sentence8, *m_sentence9, *m_sentence10, *m_sentence11, *m_sentence12;
};
